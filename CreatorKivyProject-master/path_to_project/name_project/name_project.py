...
class name_project(App):
    ...
    def build_config(self, config):
        '''РЎРѕР·РґР°С‘С‚ С„Р°Р№Р» РЅР°СЃС‚СЂРѕРµРє РїСЂРёР»РѕР¶РµРЅРёСЏ name_project.ini.'''

        config.adddefaultsection('General')
        config.setdefault('General', 'language', 'en')

    def set_value_from_config(self):
        '''РЈСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ Р·РЅР°С‡РµРЅРёСЏ РїРµСЂРµРјРµРЅРЅС‹С… РёР· С„Р°Р№Р»Р° РЅР°СЃС‚СЂРѕРµРє name_project.ini.'''
